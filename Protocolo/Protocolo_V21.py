...
class Protocolo(object):
    ...
    def make_hist(self):
        ...
        debajo de un valor. Los histogramas generados los guardara en rad'''
        ...
        for i in os.listdir(path_masks):
            ...
            if i.endswith('.TIF'):
                ...
                plt.title(self.escena + '_gr_' + banda, fontsize = 20, color="Blue")
    ...
    def get_kl(self):
        ...
        '''Este metodo obtiene los kl y los pasa al archivo kl de rad'''
    ...
    '''Funcion para reclasificar la salida de Fmask a una mascara binaria de 0 y 1'''
