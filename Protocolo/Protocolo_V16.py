...
class Protocolo(object):
    ...
    def make_hist(self):
        ...
        for i in os.listdir(path_masks):
            ...
            if i.endswith('.TIF'):
                ...
                plt.legend(loc='best');plt.title(self.escena + '_gr_' + banda, fontsize = 20, color="Blue")
    ...
    def modifyRelRad(self):
        ...
        #Copio el rel que sale del corrad a un txt para conservar los valores minimos y maximos
        rel_txt = os.path.join(path_rad, i[:-4]+'.txt')
        shutil.copy(rel_file, rel_txt)  
