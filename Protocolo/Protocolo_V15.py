...
class Protocolo(object):
    ...
    def __init__(self, ruta):
        ...
        self.parametrosnor = {}
        self.newesc = {'_id': self.escena, 'Info': {'Tecnico': 'LAST-EBD Auto', 'Iniciada': time.ctime(), 'Finalizada': '',                                   'Pasos': {'geo': '', 'rad': '', 'nor': ''}}}
    ...
    def fmask(self):
        ...
        try:
            ...
            t = time.time()
            os.system('C:/Users/Diego/Desktop/sprotocolo/ori/fmask/Fmask 1 1 0 95')
