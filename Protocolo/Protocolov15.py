...
class Protocolo(object):
    ...
    def fmask(self):
        ...
        try:
            ...
            t = time.time()
            os.system('C:/Users/Diego/Desktop/sprotocolo/ori/fmask/Fmask 10 10 0 50')
    ...
    def modify_hdr_rad(self): #En principio ya no va a hacer falta, en odo caso se podría usar xa insertar el IgnoreValue
    ...
    def modify_hdr_rad_255(self): #En principio ya no va a hacer falta, en odo caso se podría usar xa insertar el IgnoreValue
