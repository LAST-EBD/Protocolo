...
class Protocolo(object):
    ...
    #por si se quiere comprobar algo. Ya aqui se borran antes de comenzar la siguiente
        ...
        for i in os.listdir(self.ruta_escena):
            ...
            if banda in bandas:
                ...
                #creamos la mascara de agua, para ello cogemos la confianza media, a veces no hay nada en la alta           
                maskwater = masker.getwatermask(confidence.medium) 
                print 'watermin, watermax: ', maskwater.min(), maskwater.max()
                #anadimos la misma condicion que con Fmask, pero como no tenemos la mascara de NoData le decimos que el valor
                #en la banda debe de ser distinto de 0
    ...
    def reproject(self):
        ...
        for i in os.listdir(self.ruta_escena):
            ...
            elif i.endswith('MTLFmask.img') | i.endswith('_Fmask.TIF'): #anadiendo la posibilidad de mascara de calidad
    ...
    def nor1(self, banda, mascara, std = 11):
        ...
        if banda_num in dnorbandas.keys():
            ...
            #Aplicamos la mascara de Nubes. ¡¡¡¡Hay que distinguir BQA de Fmask!!!!!!!20/11/2015
    ...
    def nor2l8(self, banda, slope, intercept):
        ...
        with rasterio.drivers():
            ...
            with rasterio.open(banda) as src:
                ...
                ##Ahora miso me estoy llevando el no data a 254, hay q enmascaralo antes xa preservar este valor
    def copyDocR(self):
